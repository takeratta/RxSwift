...
* `TimeInterval` has been deprecated in favor of `DispatchTimeInterval`. For example `throttle(1.2)` would change to `throttle(.seconds(1.2))` or `throttle(.milliseconds(1200))`. #1472
